...
#' The raw-data is from Malavi data set. Contains avian malaria information for different lineage.
#' Then data was summarized counting entries for Plasmodium relictum took as raw incidence
#'
#'@docType data
#'
#'@keywords datasets
